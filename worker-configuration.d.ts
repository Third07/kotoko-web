/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 18bc2f9eadfd60707398d08a0ee09569)
// Runtime types generated with workerd@1.20260826.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	KOTOKO_MANIFEST_URL: string;
	KOTOKO_ADDONS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KOTOKO_MANIFEST_URL" | "KOTOKO_ADDONS">> {}
}
